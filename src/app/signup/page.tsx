...
import { ArrowRight, UserPlus, Mail, User } from 'lucide-react';
    ...
    <div className="flex items-center justify-center min-h-[90vh] py-12 px-4">
      <div className="w-full max-w-md bg-white border-4 border-black p-8 neo-box">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground font-medium text-center mt-1">Start your career journey today</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-4 bg-accent text-black font-bold text-lg border-4 border-black hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none transition-all flex items-center justify-center gap-2 disabled:opacity-50 mt-4"
          >
