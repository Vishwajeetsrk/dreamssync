...
import { ArrowRight, UserPlus, Mail, Lock, User, Sparkles, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      // Wait a bit so they see the success message
      setTimeout(() => {
          ...
          <AnimatePresence mode="wait">
            ...
            {success && (
              ...
              >
                ...
                <p className="font-bold text-sm leading-tight">We&apos;ve sent a verification link to <span className="underline">{email}</span>. Please verify your identity to continue.</p>
              </motion.div>
            )}
          </AnimatePresence>
